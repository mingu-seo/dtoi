...
<div class="sub">
	<div class="size">
		<h3 class="sub_title">상품 FAQ - [쓰기]</h3>
			<div class="bbs">
				...
				<input type="hidden" name="pd_no" value="${pdfaqvo.pd_no}">
				<table class="write">
					<tbody>
					<tr>
						<th scope="row"><label for="">*제목</label></th>
						<td colspan="10">
							<input type="text" id="title" name="pdfaq_title" class="w100" title="제목을 입력해주세요" />	
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="10">
							<textarea id="contents" name="pdfaq_contents" title="내용을 입력해주세요" style="width:100%;"></textarea>	
						</td>
					</tr>					
				</tbody>
			</table>
