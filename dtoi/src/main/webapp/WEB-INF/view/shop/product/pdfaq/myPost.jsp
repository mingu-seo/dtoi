...
function moveWrite() {
	...
	location.href='/dtoi/product/faq/write.do';
	</c:if>
	<c:if test="${empty authUser}">
	alert('로그인 후 이용가능합니다.');
	location.href='/dtoi/customer/login.do?url=/product/index.do'
	</c:if>	
}
