...
<div class="sub">
	<div class="size">
		<h3 class="sub_title">상품 리뷰 작성</h3>
			<div class="bbs">
				...
				<input type="hidden" name="pd_no" value="${pdreviewvo.pd_no}">
				<table class="write">
					<tbody>
					<tr>
						<th>제목</th>
						<td>
							<input type="text" id="title" name="re_title" class="w100" title="제목을 입력해주세요" />
						</td>
					</tr>
					<tr>
						<th>내용</th>
						<td>
							<textarea id="contents" name="re_content" title="내용을 입력해주세요" style="width:100%;"></textarea>
						</td>
					</tr>
					<tr>
						<th>평점</th>
						<td>
							<input type="text" name="re_score" style="width:100%;"></input>
						</td>
					</tr>
					<tr>
						<th>첨부파일</th>
