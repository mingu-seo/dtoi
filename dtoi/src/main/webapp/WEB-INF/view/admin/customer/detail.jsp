						...
						<div id="bread">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									...
									<tr>
										<th scope="row"><label for="">회원 생일</label></th>
										<td colspan="10">
											${vo.cst_birth }
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="">회원 가입일</label></th>
										<td colspan="10">
											${vo.cst_regdate }
										</td>
									</tr>												
							...
							<div class="btn">
								...
								<div class="btnRight">
									<a class="btns" style="cursor:pointer;" href="edit.do?cst_no=${vo.cst_no }"><strong>수정</strong></a>
