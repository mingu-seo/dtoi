...
function goSave() {
	...
	// 비밀번호 유효성체크
	if(!validPassword($("#ad_psd"))) return false;
				...
				<div class="con">
					...
					<div id="bbs">
						<div id="bread">
							...
							<div class="btn">
								<div class="btnLeft">
									<a class="btns" href="<%=request.getContextPath()%>/board/notice/index.do=<%=request.getAttribute("javax.servlet.forward.request_uri")%>""><strong>목록</strong></a>
								</div>
								<div class="btnRight">
